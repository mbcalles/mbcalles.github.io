  ...
  - block: markdown
    content:
      ...
      **Methodological work**
      ...
      - **Spatial risk modelling in environmental health** — earlier work mapping regional indoor radon risk across British Columbia, which established the spatial epidemiology foundation that carries through to current applications.
    design:
      columns: '1'
  - block: collection
    id: papers
