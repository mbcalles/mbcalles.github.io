...
format:
  gfm:   # Quarto → GitHub-flavored Markdown
    wrap: none
        # render math for Markdown outputs too:
    html-math-method:
      method: webtex
